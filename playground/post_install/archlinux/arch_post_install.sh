...
setup_dotfiles() {
  ...
  dot_git remote add codeberg "${codeberg_remote_base}/.dotfiles.git"
  dot_git submodule foreach "git remote add codeberg ${codeberg_remote_base}/\${name}.git"
}
